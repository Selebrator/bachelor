...
import de.lukaspanneke.bachelor.pn.sparse.ISparseIntVector;

import java.nio.ByteBuffer;
import java.util.*;

import static de.lukaspanneke.bachelor.help.Hash.hash;
import static de.lukaspanneke.bachelor.help.Search.search;
	...
	private boolean contains(SparseIntVector that, boolean checkValues) {
		...
		for (int i = 0, k = 0; i < this.size && k < that.size; ) {
			...
			if (k1 == k2) {
				 ...
				 * there must be a kay where this is 0 and that is greater 0.
				 */
